...
export const PLAYER_COMMANDS: CommandSpec[] = [
  ...
  { name: 'president', desc: 'Open the President & Elections governance menu' },
  { name: 'party', desc: 'Manage political parties and election candidacy' },
  { name: 'politics', desc: 'Inspect faction election results and administration' },
  { name: 'notifications', desc: 'Open faction dispatches and notifications inbox' },
  { name: 'inbox', desc: 'View notification messages and raid alarms' },
  { name: 'notices', desc: 'Inspect faction announcements' },
